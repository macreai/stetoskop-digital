package com.apicta.stetoskop_digital.view.doctor
 ...
 * Use the [RegisterDoctorFragment.newInstance] factory method to
...
class RegisterDoctorFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterDoctorFragment.
         */
